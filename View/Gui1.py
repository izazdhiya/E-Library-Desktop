...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		comboBoxChoices = [u"", u"2020", u"2019", u"2018", u"2017" ]
		...
		self.m_notebook1.AddPage( self.bookPanel, u"Buku", False )
		...
		self.textIdMahasiswa2 = wx.StaticText( self.historyPanel, wx.ID_ANY, u"ID Peminjaman", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_notebook1.AddPage( self.historyPanel, u"Pengembalian", True )
...
class Login ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText16 = wx.StaticText( self, wx.ID_ANY, u"Email", wx.DefaultPosition, wx.DefaultSize, 0 )
...
class Book ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.inputJudul.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_INFOTEXT ) )

		bSizer4.Add( self.inputJudul, 0, wx.ALL|wx.EXPAND, 5 )
		...
		bSizer4.Add( self.inputPengarang, 0, wx.ALL|wx.EXPAND, 5 )
		...
		bSizer4.Add( self.inputPenerbit, 0, wx.ALL|wx.EXPAND, 5 )
		...
		bSizer4.Add( self.inputTahunTerbit, 0, wx.ALL|wx.EXPAND, 5 )
		...
		self.inputRak = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer4.Add( self.inputRak, 0, wx.ALL|wx.EXPAND, 5 )
...
class Nota ( wx.Dialog ):
	...
	def __init__( self, parent, Name, Judul,Petugas, Tanggal ):
		...
		self.m_textCtrl9 = wx.TextCtrl( self, wx.ID_ANY, Name, wx.DefaultPosition, wx.Size( 150,-1 ), wx.TE_READONLY )
		...
		self.m_textCtrl91 = wx.TextCtrl( self, wx.ID_ANY, Judul, wx.DefaultPosition, wx.Size( 150,-1 ), wx.TE_READONLY )
		...
		self.m_textCtrl92 = wx.TextCtrl( self, wx.ID_ANY, Petugas, wx.DefaultPosition, wx.Size( 150,-1 ), wx.TE_READONLY )
		...
		self.m_textCtrl93 = wx.TextCtrl( self, wx.ID_ANY, Tanggal, wx.DefaultPosition, wx.Size( 150,-1 ), wx.TE_READONLY )
...
class BookModal( wx.Dialog ):

	def __init__( self, parent=None,title=wx.EmptyString, idData=False,judul=wx.EmptyString,pengarang=wx.EmptyString,penerbit=wx.EmptyString,tahunTerbit=wx.EmptyString,rakBuku=wx.EmptyString ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title =title , pos = wx.DefaultPosition, size = wx.Size( 295,403 ), style = wx.DEFAULT_DIALOG_STYLE )
		self.idData= idData
		self.SetSizeHints( wx.DefaultSize, wx.DefaultSize )
		self.SetBackgroundColour( wx.Colour( 155, 205, 255 ) )
		...
		self.inputJudul = wx.TextCtrl( self, wx.ID_ANY, judul, wx.DefaultPosition, wx.DefaultSize, 0 )
		self.inputJudul.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_INFOTEXT ) )
		...
		self.inputPengarang = wx.TextCtrl( self, wx.ID_ANY, pengarang, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer4.Add( self.inputPengarang, 0, wx.ALL|wx.EXPAND, 5 )
		...
		self.inputPenerbit = wx.TextCtrl( self, wx.ID_ANY, penerbit, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer4.Add( self.inputPenerbit, 0, wx.ALL|wx.EXPAND, 5 )
		...
		self.inputTahunTerbit = wx.TextCtrl( self, wx.ID_ANY, tahunTerbit, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer4.Add( self.inputTahunTerbit, 0, wx.ALL|wx.EXPAND, 5 )
		...
		self.inputRak = wx.TextCtrl( self, wx.ID_ANY, rakBuku, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer4.Add( self.inputRak, 0, wx.ALL|wx.EXPAND, 5 )
		gSizer2 = wx.GridSizer( 0, 2, 0, 0 )
